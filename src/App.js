  ...
  render() {
    ...
    return (
      <div className={"App"}>
        ...
        <ApiCallComponent searched={this.state.searched} resetSearchTerms={this.resetSearchTerms} searchCoords={this.state.city} setSummary={this.setSummary} manualSearch={this.manualsearch} />
