            ...
            <div style={{ filter: `blur(${this.state.blur}rem)` }}>
                <div className="jumbotron jumbotron-fluid bg-transparent">
                    <div className="container today-container">
                        <h1 className="display-4">Riding weather in {this.getCity() || 'Mordor'}: </h1>
